...
public class daftardata {
    ...
    public static void main(String[] args) throws IOException {
        ...
        URL myAddres = koneksisaya.buidURL("https://farmasi.mimoapps.xyz/mimoqss2auyqD1EAlkgZCOhiffSsFl6QqAEIGtM");
        ...
        for (int index=0; index < modelfarmasis.size();index++ ){
            int hargaobat = Integer.parseInt(modelfarmasis.get(index).getI_sell());
            if (hargaobat <= 2000){
                jumlahdata++;
